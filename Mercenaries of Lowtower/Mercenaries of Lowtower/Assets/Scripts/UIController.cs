...
public class UIController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        icons[1].material.SetTexture("_SecondTex", Resources.Load("Textures/BubbleShieldBW") as Texture);

        icons[2].material.SetFloat("_Tween", playerCooldowns.activeCooldowns[2] / playerCooldowns.abilityCooldowns[2]);
        icons[2].material.SetTexture("_MainTex", Resources.Load("Textures/ReflectionAttack") as Texture);
