...
public class UIController : MonoBehaviour
{
   ...
   public  float[] playerCurrentHealth;
    ...
    void Update()
    {
        ...
        icons[1].material.SetFloat("_Tween", players[0].GetComponent<TankCooldowns>().cooldowns["magnetCD"] / players[0].GetComponent<TankCooldowns>().magnetCD);
        icons[1].material.SetTexture("_MainTex", Resources.Load("Textures/MagnetPull") as Texture);
        icons[1].material.SetTexture("_SecondTex", Resources.Load("Textures/MagnetPullBlack") as Texture);
