...
public class THICCBossControlScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (bossPhase == 1)
        {
            BossArmsList[0].GetComponent<THICCBossArmScript>().armRaising = true;
            BossArmsList[2].GetComponent<THICCBossArmScript>().armRaising = true;
            BossArmsList[3].GetComponent<THICCBossArmScript>().armRaising = true;
            BossArmsList[5].GetComponent<THICCBossArmScript>().armRaising = true;
            bossPhase++;
        }

        if (bossPhase == 3)
        {
            BossArmsList[1].GetComponent<THICCBossArmScript>().armRaising = true;
            BossArmsList[4].GetComponent<THICCBossArmScript>().armRaising = true;
            bossPhase++;
        }
