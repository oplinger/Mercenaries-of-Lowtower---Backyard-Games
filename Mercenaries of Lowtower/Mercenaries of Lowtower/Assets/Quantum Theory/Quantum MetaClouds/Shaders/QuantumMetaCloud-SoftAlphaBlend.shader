Shader "QuantumTheory/Old - QuantumMetaCloud-SoftAlphaBlend"
{
	Properties 
	{
...
Mode Off
		...
		CGPROGRAM
#pragma surface surf BlinnPhongEditor  softvegetation noambient nolightmap alpha decal:blend 
#pragma target 2.0
...
float4 Subtract1=float4( Split0.z, Split0.z, Split0.z, Split0.z) - _AlphaCutoff.xxxx;
