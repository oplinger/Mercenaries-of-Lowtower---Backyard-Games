...
Shader "QuantumTheory/3DCloudModels-AlphaClip" {
    Properties {
        ...
        _CloudGrowth ("Cloud Growth", Range(1, -1)) = -0.3191701
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                clip(saturate(((pow(((1.0 - node_420.r)-_CloudGrowth),0.4)*node_420.g)*2.0)) - 0.5);
////// Lighting:
////// Emissive:
                float node_429 = 0.5;
